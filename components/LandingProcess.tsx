...
const LandingProcess: React.FC = () => {
  const steps = [
    { num: "01", title: "შეარჩიე ქინძმარაული", desc: "მოგვწერეთ სასურველი ტექსტი ბოთლის მინაზე ამოტვიფრული გრავირებისთვის." },
    { num: "02", title: "დაწერე ტექსტი", desc: "ჩვენ მოვამზადებთ პერსონალურ დიზაინს, რომელსაც გამოგიგზავნით მითითებულ მეილზე და დადასტურების შემდეგ დავიწყებთ თქვენი შეკვეთის დამზადებას." },
    { num: "03", title: "მიიღე სწრაფად", desc: "შეკვეთას 1-3 სამუშაო დღეში მიიღებ ადგილზე" },
  ];
