      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <ul className="space-y-4 text-lg">
            {[
              "მოგვწერე სასურველი ტექსტი ბოთლის მინაზე ამოტვიფრული გრავირებისთვის. ჩვენ მოვამზადებთ პერსონალურ დიზაინს და დადასტურების შემდეგ დავიწყებთ შეკვეთის დამზადებას.",
