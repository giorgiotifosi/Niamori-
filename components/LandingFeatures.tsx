          ...
          <div className="bg-[#121212] p-10 rounded-3xl border border-white/5 group hover:border-[#d4af37]/30 transition-all">
            <div className="text-[#d4af37] mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.718 2.154a2 2 0 001.103 2.454l2.154.718a2 2 0 002.454-1.103l.718-2.154a2 2 0 00-1.414-1.96l-2.387-.477a2 2 0 00-1.96 1.414l-.718 2.154a2 2 0 001.103 2.454l2.154.718a2 2 0 002.454-1.103l.718-2.154a2 2 0 00-1.414-1.96l-2.387-.477a2 2 0 00-1.96 1.414l-.718 2.154a2 2 0 001.103 2.454l2.154.718a2 2 0 002.454-1.103l.718-2.154a2 2 0 00-1.414-1.96l-2.387-.477a2 2 0 00-1.96 1.414l-.718 2.154a2 2 0 001.103 2.454l2.154.718a2 2 0 002.454-1.103l.718-2.154a2 2 0 00-1.414-1.96l-2.387-.477a2 2 0 00-1.96 1.414l-.718 2.154a2 2 0 001.103 2.454l2.154.718a2 2 0 002.454-1.103l.718-2.154" />
              </svg>
            </div>
